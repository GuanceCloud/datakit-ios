...
- (void)startMonitor{
    [self bluteeh];
    ZYDebug(@"getWifiAndIPAddress = %@",[self getWifiAndIPAddress]);
    ZYDebug(@"getLaunchSystemTime = %ld",[self getLaunchSystemTime]);
    ZYDebug(@"userDeviceName = %@",[self userDeviceName]);
//    ZYDebug(@"hostName = %@",[self hostName]);
