...
- (void)createUI{
    self.datas = @[@{@"Trace":@"Network Link Tracing"},
    ];
...
-(void)tableViewSelectionDidChange:(NSNotification *)notification{
    ...
    NSDictionary *traceHeader = [[FTExternalDataManager sharedManager] getTraceHeaderWithKey:key url:[NSURL URLWithString:urlStr]];
