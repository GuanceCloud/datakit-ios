...
- (void)testLineProtocol_EqualsSign{
    ...
    NSString *lineStr = [line getRequestBodyWithEventArray:@[model] requestNumber:@"1" enableIntegerCompatible:NO];
...
- (void)testDataUUID{
    ...
    NSString *lineStr = [line getRequestBodyWithEventArray:@[model] requestNumber:@"1" enableIntegerCompatible:NO];
    NSString *lineStr2 = [line getRequestBodyWithEventArray:@[model] requestNumber:@"1" enableIntegerCompatible:NO];
...
- (void)sdkDataEnableIntegerCompatible:(BOOL)enable{
    ...
    model.data =[FTJSONUtil convertToJsonData:data];
    FTRequestLineBody *line = [[FTRequestLineBody alloc]init];
    NSString *lineStr = [line getRequestBodyWithEventArray:@[model] requestNumber:@"1" enableIntegerCompatible:enable];
