...
- (void)testEnableAutoTrackView{
    [[FTAutoTrackHandler sharedInstance] startWithTrackView:YES action:NO addRumDatasDelegate:nil viewHandler:nil swiftUIViewHandler:nil swiftUIActionHandler:nil actionHandler:nil displayMonitor:nil];
    
    XCTAssertTrue([FTAutoTrackHandler sharedInstance].viewControllerHandler != nil);
}
- (void)testDisableAutoTrackView{
    [[FTAutoTrackHandler sharedInstance] startWithTrackView:NO action:NO addRumDatasDelegate:nil viewHandler:nil swiftUIViewHandler:nil swiftUIActionHandler:nil actionHandler:nil displayMonitor:nil];
...
- (void)testViewDidAppear{
    ...
    [[FTAutoTrackHandler sharedInstance] startWithTrackView:YES action:NO addRumDatasDelegate:handler viewHandler:nil swiftUIViewHandler:nil swiftUIActionHandler:nil actionHandler:nil displayMonitor:nil];
