...
@interface FTIssueInfo (Internal)
...
@interface FTIssueFieldEnricher : NSObject

- (instancetype)initWithProvider:(nullable FTIssueDataProvider)provider NS_DESIGNATED_INITIALIZER;
