...
NSString * const FT_MACOS_SERVICE_NAME = @"df_rum_macos";
...
NSString * const FT_RUM_SESSION_REPLAY_ON_ERROR_SAMPLE_RATE = @"session_replay_on_error_sample_rate";
NSString * const FT_RUM_SESSION_SAMPLE_RATE = @"session_sample_rate";
NSString * const FT_RUM_SESSION_REPLAY_SAMPLE_RATE = @"session_replay_sample_rate";
NSString * const FT_RUM_KEY_SAMPLED_FOR_ERROR_SESSION = @"sampled_for_error_session";
NSString * const FT_RUM_KEY_SAMPLED_FOR_ERROR_REPLAY = @"sampled_for_error_replay";
...
NSString * const FT_KEY_RESOURCE_WEBSOCKET_COLLECTION_LEVEL = @"resource_websocket_collection_level";
NSString * const FT_KEY_RESOURCE_WEBSOCKET_HANDSHAKE_STATE = @"resource_websocket_handshake_state";
...
NSString * const FT_RESOURCE_TYPE_WEBSOCKET = @"websocket";
NSString * const FT_RESOURCE_WEBSOCKET_COLLECTION_LEVEL_HANDSHAKE = @"handshake";
NSString * const FT_RESOURCE_WEBSOCKET_HANDSHAKE_STATE_SUCCESS = @"success";
NSString * const FT_RESOURCE_WEBSOCKET_HANDSHAKE_STATE_REJECTED = @"rejected";
NSString * const FT_RESOURCE_WEBSOCKET_HANDSHAKE_STATE_FAILED = @"failed";
//trace link rum tag
