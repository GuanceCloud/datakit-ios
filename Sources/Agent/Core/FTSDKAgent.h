...
/// The minimum update time interval defaults to FTSDKConfig.remoteConfigMiniUpdateInterval. If the time interval since the last request doesn't meet the setting, no request will be initiated
