...
- (void)rumEStags:(NSDictionary *)tags{
    XCTAssertTrue([tags.allKeys containsObject:@"app_id"]&&[tags.allKeys containsObject:@"app_identifier"]&&[tags.allKeys containsObject:@"app_name"]&&[tags.allKeys containsObject:@"device"]&&[tags.allKeys containsObject:@"env"]&&[tags.allKeys containsObject:@"model"]&&[tags.allKeys containsObject:@"network_type"]&&[tags.allKeys containsObject:@"os"]&&[tags.allKeys containsObject:@"screen_size"]&&[tags.allKeys containsObject:@"version"]&&[tags.allKeys containsObject:@"terminal"]&&[tags.allKeys containsObject:@"device_uuid"]&&[tags.allKeys containsObject:@"type"]&&[tags.allKeys containsObject:@"userid"]&&[tags.allKeys containsObject:@"is_signin"]&&[tags.allKeys containsObject:@"origin_id"]);
}
- (void)setESConfig{
    FTMobileConfig *config = [[FTMobileConfig alloc]initWithMetricsUrl:self.url];
    config.appid = self.appid;
