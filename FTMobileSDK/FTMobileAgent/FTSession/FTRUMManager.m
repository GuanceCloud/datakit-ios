...
- (void)ftResourceCompleted:(FTTaskInterceptionModel *)resourceModel{
    ...
    if(error){
        ...
        [self resourceError:resourceModel.identifier tags:tags fields:field time:taskMes.responseEndDate];
    }else{
        ...
        [self resourceCompleted:resourceModel.identifier tags:tags fields:fields time:taskMes.responseEndDate];
    }
}
