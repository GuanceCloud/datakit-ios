...
- (NSArray<FTSRWireframe *> *)buildWireframesWithBuilder:(FTSessionReplayWireframesBuilder *)builder {
    ...
    FTSRShapeWireframe *divider = [[FTSRShapeWireframe alloc]initWithIdentifier:self.dividerWireframeID frame:dividerRect clip:self.attributes.clip backgroundColor:[FTSystemColors placeholderTextColorStr] cornerRadius:nil opacity:nil];
