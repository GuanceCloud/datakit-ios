...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "http://gitlab.jiagouyun.com/cma/ft-sdk-ios.git", :tag => "agent_1.0.0-alpha.3" }
  ...
  #s.source_files  = "ft-sdk-ios/Pod_Products/FTMobileAgent.framework/Headers/*.{h}"
  #s.exclude_files = "Classes/Exclude"

  # s.public_header_files = "Classes/**/*.h"

  s.vendored_frameworks = 'ft-sdk-ios/Pod_Products/FTMobileAgent.framework'
