...
- (void)viewDidLoad {
    ...
    UIButton *immediate = [[UIButton alloc]initWithFrame:CGRectMake(50, 450, 150, 100)];
    immediate.backgroundColor = [UIColor redColor];
    [immediate setTitle:@"testImmediate" forState:UIControlStateNormal];
    [immediate addTarget:self action:@selector(testImmediate) forControlEvents:UIControlEventTouchUpInside];
